...
\begin{document}			
	...
	\subsection{Správa školy}
	\subsubsection{Docházka}
	\subsubsection{Rozvrh hodin a suplování}
	\subsubsection{Komunikace}
	\subsubsection{Evidence osobních dat}
	\subsubsection{Výpočet platů}
	\subsubsection{Inventární seznam}
	...
	Rozšíření systému správy školy by povolilo školám plně přejít na tento systém. Nejpodstatnější funkce, které v tuto chvíli schází, jsou:
	\begin{itemize}
