...
\begin{document}			
	...
	19. století, nesmí zůstat pozadu. Mělo by využívat dnešní moderní možnosti, které razantně výuku usnadňují, vylepšují a poskytují ohromný potenciál k rozvoji schopností a kompetencí.
	
	Cílem tohoto projektu je implementace digitální učebnice, která by splňovala všechna didaktická doporučení, bude příjemná pro použítí jak pedagogy, tak i žáky či studenty, kterou bude možné použít na jakýkoliv předmět a která, za pomocí psychologie, gamifikace a nových technologií - například NLP modelů - bude motivovat žáky k výuce předmětu a k dosažení lepších výsledků. 
	
	
	% TODO finish
	% https://publikacje.pan.pl/book/148575/krzyzyk-danuta-synowiec-helena-jezyk-podrecznikow-szkolnych-w-kontekscie-ich-funkcji-dydaktycznych-2023\
	% https://publikacje.pan.pl/dlibra/flipbook/129335
	
	% začátek práce
	
	\newpage
	\section{Teoretické východisko}
	\subsection{Cíle učebnice}
	Hlavní funkce učebnice je možné určit následovně
	
	\subsection{Problémy současných učebnic}
	
	\subsection{Problémy současných digitálních učebnic}
	...
	\newpage
	\subsection{Standardy učebnice a jejich plnění}
	...
	\filbreak
	   ...
	   Toto pravidlo učebnice splňuje za pomocí integrované kontroly chyb v editoru textu. Při jakékoliv nalezené chybě bude autor učebnice před uložením textu upozoněn, a následně se může rozhodnout buď pro proignorování chyby, nebo pro její nápravu.
	\end{samepage}
