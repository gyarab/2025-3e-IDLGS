...
\begin{document}			
	...
	\begin{itemize}
		...
		\item Školní administrace zaměstnanců
	...
	Oficiální certifikace o zabezpečení (a zároveň s tím spojené posílení zabezpečení) a ochraně dat by jednoznačně také mohlo prospět budoucí adopci systému. Jedná se o certifikaci pro, mimo jiné, směrnice EU NIS2 a GDPR.
