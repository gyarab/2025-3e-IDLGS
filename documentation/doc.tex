...
\begin{document}			
	...
	\begin{samepage}
		...
		Tento požadavek je splněn funkce \enquote{Definice pojmů}. Autor učebnice přídá pro každý pojem definici, a systém následně automaticky definici na stejné straně přídá při kliknutí na slovo. Zároveň strana definice pojmů pro uživatele plní funkci přehledu.
	\end{samepage}
