...
{#if open}
	<div
		class="fixed top-0 left-0 z-50! flex h-screen! w-screen! flex-col items-center justify-center bg-neutral-500/40"
	>
		<dialog
			bind:this={dialog}
			class="absolute top-1/2 left-1/2 z-51! flex min-h-40 sm:top-2/5 {css} 
				...
				{darkMode ? 'bg-neutral-900/80 text-white' : 'bg-neutral-100/80 text-black'}"
