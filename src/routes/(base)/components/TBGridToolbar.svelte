...
{#key texts || actions || emojis}
    <div class="overflow-hidden rounded-xl {cssTop}" style="background-color: white;">
            ...
            {#each { length: length } as _, i (i)}
                <button
                    class="{css} {isSelected?.at(i) ? selectedcss : ''}
                        ...
                        hover:translate-0 active:rounded-xl hover:brightness-110 active:brightness-90 sm:gap-1 
