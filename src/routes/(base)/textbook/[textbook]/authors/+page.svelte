<script lang="ts">
	...
	import type { TextbookType, ChapterTypeRaw, UserTypeInfo } from "$lib/types";
...
<svelte:head>
	<title>
		{m.textbookAuthorsList()} | {data.textbook.title} | {m.idlgs()}
	</title>
</svelte:head>
