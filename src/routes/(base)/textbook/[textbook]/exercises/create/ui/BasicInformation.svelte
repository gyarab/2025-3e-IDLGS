...
<div class="flex w-full grow flex-col gap-2">
	...
	<span in:fly={{ x: 300, y: 0, duration: 300, delay: 300, opacity: 0 }}>
		<TextInput
			bind:value={name}
			{darkMode}
			{color}
	...
	<span
		...
		in:fly={{ x: 300, y: 0, duration: 300, delay: 500, opacity: 0 }}
	>
		<TextArea
	...
	<span
		in:fly={{ x: 300, y: 0, duration: 300, delay: 700, opacity: 0 }}
