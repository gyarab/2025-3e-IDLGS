...
>
    <i class="ri-mail-send-line absolute right-1/15 bottom-1/6 scale-200 rotate-15 text-9xl text-white opacity-20"></i>
    <i class="ri-customer-service-2-line absolute top-1/4 left-1/15 scale-200 -rotate-15 text-9xl text-white opacity-20"></i>
        ...
        <section>
            ...
            >
                <div class="flex-1 overflow-hidden">
                    <h3 class="text-xs font-bold tracking-widest uppercase opacity-50 mb-1">
                        {locale === 'cs' ? 'Podpora' : locale === 'pl' ? 'Wsparcie' : 'Support'}
                    </h3>
                    <p class="text-sm font-semibold sm:text-base">Martin Bykov</p>
