...
<Form
	...
	>
		...
		>
			...
			<PasswordInput cssClass="w-full" formName="password" label={m.newPassword()} bind:value={passwordValue}/>
			<PasswordInput cssClass="w-full" formName="rpassword" label={m.confirmPassword()} bind:value={passwordRepeat} />
		
			<PasswordInputValid password={passwordValue} bind:valid={passwordValid} />
